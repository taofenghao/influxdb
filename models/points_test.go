...
func TestValidTagTokens(t *testing.T) {
	testCases := []struct {
		...
		{tags: models.NewTags(map[string]string{models.MeasurementInternalTagKey: "bar"}), expected: true},
		...
		{tags: models.NewTags(map[string]string{models.FieldKeyInternalTagKey: "bar"}), expected: true},
